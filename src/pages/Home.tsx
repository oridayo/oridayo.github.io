    ...
    return (
        <div className="container m-auto py-2">
            <div className="hero-section">
                <h1 className="hero-title">Marcus Mun</h1>
                <p className="hero-subtitle">Full-Stack Developer | Kuala Lumpur, Malaysia</p>
            </div>

            <div className="about-section section-spacing">
                <h2 className="mb-3">About Me</h2>
                <p className="lead">
                    Hi, I'm Marcus, a passionate full-stack developer based in Kuala Lumpur, Malaysia.
                    As a fresh graduate, I'm eager to apply my skills in modern web technologies and
                    contribute to innovative projects. This portfolio showcases some of the work I've
                    been developing throughout my university journey.
                </p>
                <p>
                    I specialize in React, TypeScript, and modern web development, always excited to
